...
import com.amethystum.manage.modules.base.dao.DictDataDao;
import com.amethystum.manage.modules.base.entity.DictData;
import com.amethystum.manage.modules.base.service.DictDataService;
    ...
    public Page<DictData> findByCondition(DictData dictData, Pageable pageable) {
        ...
        return dictDataDao.findAll(new Specification<DictData>() {
            ...
            public Predicate toPredicate(Root<DictData> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
                ...
                //模糊搜素
                if(!StringUtils.isEmpty(dictData.getTitle())){
                ...
                //所属字典
                if(!StringUtils.isEmpty(dictData.getDictId())){
