...
import com.amethystum.manage.modules.base.service.*;
...
public class UserController {
    ...
    public Result<Object> regist(@ModelAttribute User u,
        ...
        if(StringUtils.isEmpty(verify)|| StringUtils.isEmpty(u.getUsername())
    ...
    public Result<Page<User>> getByCondition(@ModelAttribute User user,
        ...
        for(User u: page.getContent()){
            // 关联部门
            if(!StringUtils.isEmpty(u.getDepartmentId())){
