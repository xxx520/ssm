package com.amethystum.manage.config.security.jwt;

import com.amethystum.manage.common.constant.SecurityConstant;
import com.amethystum.manage.common.utils.ResponseUtil;
import com.amethystum.manage.common.vo.TokenUser;
...
public class JWTAuthenticationFilter extends BasicAuthenticationFilter   {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        Boolean notValid = StringUtils.isEmpty(header) || (!tokenRedis && !header.startsWith(SecurityConstant.TOKEN_SPLIT));
        if (notValid) {
