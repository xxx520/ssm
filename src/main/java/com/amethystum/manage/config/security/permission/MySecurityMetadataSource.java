package com.amethystum.manage.config.security.permission;

import com.amethystum.manage.common.constant.CommonConstant;
import com.amethystum.manage.modules.base.entity.Permission;
import com.amethystum.manage.modules.base.service.PermissionService;
...
public class MySecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public void loadResourceDefine(){
        ...
        for(Permission permission : permissions) {
            if(!StringUtils.isEmpty(permission.getTitle())&&!StringUtils.isEmpty(permission.getPath())){
