...
public class XGenerator {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	daoPackage="com.amethystum.manage.modules.api.dao";
    	entityPackage="com.amethystum.manage.modules.api.entity";
    	servicePackage="com.amethystum.manage.modules.api.service";
    	serviceImplPackage="com.amethystum.manage.modules.api.serviceimpl";
    	
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/amethystum/manage/generator/template";
